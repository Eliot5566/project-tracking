...
function ProjectForm(_a) {
    ...
    var fetchTeamMembers = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('獲取團隊成員列表失敗:', error_1);
                    return [3 /*break*/, 4];
    ...
    react_1.useEffect(function () {
        if (open && initialData) {
            form.setFieldsValue(__assign(__assign({}, initialData), { startDate: dayjs_1["default"](initialData.startDate), endDate: dayjs_1["default"](initialData.endDate) }));
        }
        else {
            form.resetFields();
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, onSubmit(__assign(__assign({}, values), { startDate: values.startDate.format('YYYY-MM-DD'), endDate: values.endDate.format('YYYY-MM-DD') }))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2:
                    error_2 = _a.sent();
                    antd_1.message.error('請填寫所有必填欄位');
                    return [3 /*break*/, 4];
                case 3:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    return (React.createElement(antd_1.Modal, { title: initialData ? '編輯專案' : '新增專案', open: open, onOk: function () { return form.submit(); }, onCancel: onClose, confirmLoading: loading },
        React.createElement(antd_1.Form, { form: form, layout: "vertical", onFinish: handleSubmit },
            ...
            React.createElement(antd_1.Form.Item, { name: "managerId", label: "\u5C08\u6848\u8CA0\u8CAC\u4EBA", rules: [{ required: true, message: '請選擇專案負責人' }] },
            ...
            React.createElement(antd_1.Form.Item, { name: "status", label: "\u72C0\u614B", rules: [{ required: true, message: '請選擇狀態' }] },
                React.createElement(antd_1.Select, null,
                    React.createElement(antd_1.Select.Option, { value: "pending" }, "\u5F85\u958B\u59CB"),
                    ...
                    React.createElement(antd_1.Select.Option, { value: "cancelled" }, "\u5DF2\u53D6\u6D88"))),
