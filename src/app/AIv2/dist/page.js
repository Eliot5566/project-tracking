...
function AIForgingThreadingSuite() {
    ...
    var _r = react_1.useState('visual'), viewMode = _r[0], setViewMode = _r[1];
    var _s = react_1.useState('all'), focusProcess = _s[0], setFocusProcess = _s[1];
    // 表格高亮的最後點選列（僅用於 UI 高亮，不影響面板資料）
    var _t = react_1.useState(null), selectedKey = _t[0], setSelectedKey = _t[1];
    // 打頭/搓牙各自獨立的選取鍵，避免點選一方影響另一方的面板
    var _u = react_1.useState(null), selectedHeadingKey = _u[0], setSelectedHeadingKey = _u[1];
    var _v = react_1.useState(null), selectedThreadingKey = _v[0], setSelectedThreadingKey = _v[1];
    // 載入：從 API 取得清單並補充假欄位
    ...
    // ===== 視覺化輔助：依區域分組與健康度上色 =====
    var getArea = function (machine) { var _a, _b, _c; return ((_c = (_b = (_a = machine === null || machine === void 0 ? void 0 : machine[0]) === null || _a === void 0 ? void 0 : _a.toUpperCase) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : 'A'); };
    var colorFromHealth = function (h) {
        var v = typeof h === 'number' ? h : -1;
        if (v < 0)
            return { bg: '#9e9e9e', fg: '#ffffff' }; // 灰：未知
        if (v <= 30)
            return { bg: '#ff4d4f', fg: '#ffffff' }; // 紅：0~60
        if (v <= 50)
            return { bg: '#ffeb3b', fg: '#333333' }; // 黃：61~80
        return { bg: '#155724', fg: '#ffffff' }; // 綠：81+
    };
    var areaOrder = ['A', 'B', 'C', 'D'];
    // 產生機台序列（降冪顯示，符合圖示從上到下）
    var gen = function (prefix, start, end) {
        var arr = [];
    ...
    var getRowByMachine = function (code) {
        var _a;
        return ((_a = workOrders.find(function (w) { return w.machine === code; })) !== null && _a !== void 0 ? _a : null);
    };
    return (React.createElement("div", { className: "p-6 bg-gray-50 min-h-screen" },
        React.createElement(antd_1.Typography.Title, { level: 2 }, "\u6A21\u5177\u9810\u8A3A\u7CFB\u7D71 \u2014 MPDS (Mold Predictive Diagnosis System)"),
        React.createElement(antd_1.Typography.Paragraph, null,
            "\u9EDE\u9078\u4E0B\u65B9 ",
            React.createElement("b", null, "\u5DE5\u55AE/\u6A5F\u53F0"),
            " \u4EFB\u4E00\u5217\uFF0C\u4E0A\u65B9\u7684 ",
            React.createElement("b", null, "MPDS \u7E3D\u89BD"),
            " \u8207 ",
            React.createElement("b", null, "\u8DA8\u52E2\u5716"),
            " \u5C07\u81EA\u52D5\u5207\u63DB\u70BA\u8A72\u7B46\u6A5F\u53F0/\u6A21\u5177\u7684\u5373\u6642\u8996\u5716\u3002"),
        focusProcess !== 'all' && (React.createElement("div", { style: { marginBottom: 12 } },
            React.createElement(antd_1.Space, null,
                React.createElement(antd_1.Tag, { color: "processing" },
                    "\u76EE\u524D\u7126\u9EDE\uFF1A",
                    focusProcess),
                React.createElement(antd_1.Button, { size: "small", onClick: function () { return setFocusProcess('all'); } }, "\u986F\u793A\u5168\u90E8\u88FD\u7A0B")))),
        React.createElement(antd_1.Row, { gutter: [16, 16] },
            focusProcess !== '搓牙' && (React.createElement(antd_1.Col, { xs: 24, lg: focusProcess === '打頭' ? 24 : 12 },
                React.createElement(antd_1.Card, { title: React.createElement(antd_1.Space, null,
                        ...
                        "\u6253\u982D\u6A21\u5177 MPDS \u7E3D\u89BD"), extra: React.createElement(antd_1.Space, null,
                        ...
                        return bands ? (React.createElement(React.Fragment, null,
                            ...
                            React.createElement(antd_1.Row, { gutter: 12 },
                                React.createElement(antd_1.Col, { span: 12 },
                                    React.createElement(antd_1.Typography.Text, { type: "secondary" }, "\u8A72\u6A21\u5177\u7570\u5E38\u4E3B\u8981\u539F\u56E0 Top3"),
            ...
            focusProcess !== '打頭' && (React.createElement(antd_1.Col, { xs: 24, lg: focusProcess === '搓牙' ? 24 : 12 },
                React.createElement(antd_1.Card, { title: React.createElement(antd_1.Space, null,
                        React.createElement(lucide_react_1.Wrench, { size: 18 }),
                        "\u6413\u7259\u6A21\u5177 MPDS \u7E3D\u89BD"), extra: React.createElement(antd_1.Space, null,
            ...
            focusProcess !== '搓牙' && (React.createElement(antd_1.Col, { xs: 24, lg: focusProcess === '打頭' ? 24 : 12 },
                React.createElement(antd_1.Card, { title: React.createElement(antd_1.Space, null,
                    ...
                    return adv ? (React.createElement(React.Fragment, null,
                        ...
                        React.createElement("ul", { style: { marginTop: 8, paddingLeft: 18 } }, adv.reasons.map(function (r) { return React.createElement("li", { key: r, className: "text-gray-600" }, r); })),
                        React.createElement(antd_1.Divider, null),
        ...
        React.createElement(antd_1.Row, { gutter: [16, 16], className: "mt-4" },
            React.createElement(antd_1.Col, { xs: 24, lg: 10 },
                React.createElement(antd_1.Card, { title: React.createElement(antd_1.Space, null,
                        ...
                        "\u6A21\u5177\u4E3B\u8981\u5931\u6548\u6A21\u5F0F\uFF08FMECA\uFF09") },
                    React.createElement(antd_1.Typography.Paragraph, { style: { marginTop: 4 } }, "Failure Modes, Effects, and Criticality Analysis\uFF08\u5931\u6548\u6A21\u5F0F\u3001\u5F71\u97FF\u8207\u95DC\u9375\u5EA6\u5206\u6790\uFF09\uFF1A \u7528\u65BC\u7CFB\u7D71\u5316\u8B58\u5225\u300C\u6703\u600E\u9EBC\u58DE\u300D\u300C\u5F71\u97FF\u591A\u5927\u300D\u300C\u512A\u5148\u8655\u7406\u54EA\u88E1\u300D\uFF0C\u4E26\u7D50\u5408\u5373\u6642\u8DA8\u52E2\u8207 MPDS \u5236\u5B9A\u4FDD\u990A/\u66F4\u63DB\u7B56\u7565\u3002"),
                    ['崩角/裂紋', '磨耗超限', '變形'].map(function (m, idx) {
        ...
        React.createElement(antd_1.Row, { gutter: [16, 16], className: "mt-4" },
            React.createElement(antd_1.Col, { xs: 24 },
                React.createElement(antd_1.Card, { title: React.createElement(antd_1.Space, null,
                        ...
                        "\u73FE\u884C\u751F\u7522\u4E2D \u2014 \u6A5F\u53F0\u7E3D\u89BD\uFF08\u9EDE\u9078\u65B9\u584A\u5207\u63DB\u4E0A\u65B9\u8996\u5716\uFF09"), extra: React.createElement(antd_1.Space, null,
                        React.createElement(antd_1.Segmented, { options: [{ label: '視覺化', value: 'visual' }, { label: '列表', value: 'list' }], value: viewMode, onChange: function (v) { return setViewMode(v); } })) },
                    viewMode === 'list' ? (React.createElement(antd_1.Table, { columns: columns, dataSource: workOrders, pagination: { pageSize: 8 }, size: "small", rowClassName: function (record) { return record.key === selectedKey ? 'bg-blue-50' : ''; }, onRow: function (record) { return ({
                            onClick: function () {
                        ...
                        }); }, loading: loading })) : (React.createElement(antd_1.Row, { gutter: [16, 16] }, areaOrder.filter(function (a) { return areaTemplates[a]; }).map(function (area) {
                        var tpl = areaTemplates[area];
                        var Block = function (_a) {
                            var _b, _c, _d, _e, _f;
                            var code = _a.code;
                            var row = getRowByMachine(code);
                            var metrics = row ? deriveMetrics(row) : null;
                            var _g = colorFromHealth((_b = metrics === null || metrics === void 0 ? void 0 : metrics.health) !== null && _b !== void 0 ? _b : null), bg = _g.bg, fg = _g.fg;
                            var isSelected = row && selectedKey === row.key;
                            var clickable = !!row; //!!row 代表將 row 轉換為布林值
                            return (React.createElement("div", { onClick: function () {
                                    if (!row)
                                        return;
                                    setSelectedKey(row.key);
                                    if (row.process === '打頭') {
                                        setSelectedHeadingKey(row.key);
                                        setFocusProcess('打頭');
                                    }
                                    else {
                                        setSelectedThreadingKey(row.key);
                                        setFocusProcess('搓牙');
                                    }
                                }, style: {
                                    background: bg,
                                ...
                                }, title: clickable ? "\u6A5F\u53F0 " + code + " / \u5065\u5EB7\u5EA6 " + ((_c = metrics === null || metrics === void 0 ? void 0 : metrics.health) !== null && _c !== void 0 ? _c : 0).toFixed(0) + "% / RUL " + ((_f = (_e = (_d = metrics === null || metrics === void 0 ? void 0 : metrics.rulShots) === null || _d === void 0 ? void 0 : _d.toLocaleString) === null || _e === void 0 ? void 0 : _e.call(_d)) !== null && _f !== void 0 ? _f : 0) + " \u6B21" : "\u6A5F\u53F0 " + code + "\uFF08\u672A\u751F\u7522\uFF09" }, code));
                        };
                        return (React.createElement(antd_1.Col, { xs: 24, lg: 12, xl: 6, key: area },
                            React.createElement("div", { style: { border: '1px solid #e5e7eb', borderRadius: 8, padding: 5 } },
                                React.createElement(antd_1.Row, { gutter: 8 },
                                    React.createElement(antd_1.Col, { span: 10 }, tpl.left.map(function (code) { return React.createElement(Block, { key: code, code: code }); })),
                                    React.createElement(antd_1.Col, { span: 4 },
                                        React.createElement("div", { style: { height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 6 } },
                                            React.createElement(antd_1.Typography.Text, { strong: true }, (area === 'A' || area === 'D') ? 'Heading' : 'Threading'),
                                            React.createElement(antd_1.Typography.Text, { type: "secondary" }, "Rolling"),
                                            React.createElement(antd_1.Divider, { style: { margin: '8px 0' } }),
                                            React.createElement(antd_1.Typography.Text, null,
                                                "Area ",
                                                area))),
                                    React.createElement(antd_1.Col, { span: 10 }, tpl.right.map(function (code) { return React.createElement(Block, { key: code, code: code }); }))))));
                    }))),
                    React.createElement(antd_1.Divider, { style: { margin: '12px 0' } }),
                    React.createElement(antd_1.Space, { wrap: true, size: 8 },
                        React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6 } },
                            React.createElement("span", { style: { width: 14, height: 14, background: '#155724', display: 'inline-block', borderRadius: 3 } }),
                            React.createElement(antd_1.Typography.Text, null, "\u7DA0\u8272\uFF1A50% \u4EE5\u4E0A")),
                        React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6 } },
                            React.createElement("span", { style: { width: 14, height: 14, background: '#ffeb3b', display: 'inline-block', borderRadius: 3, border: '1px solid #d4b106' } }),
                            React.createElement(antd_1.Typography.Text, null, "\u9EC3\u8272\uFF1A31%\u201349%")),
                        React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6 } },
                            React.createElement("span", { style: { width: 14, height: 14, background: '#ff4d4f', display: 'inline-block', borderRadius: 3 } }),
                            React.createElement(antd_1.Typography.Text, null, "\u7D05\u8272\uFF1A0%\u201330%")),
                        React.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6 } },
                            React.createElement("span", { style: { width: 14, height: 14, background: '#9e9e9e', display: 'inline-block', borderRadius: 3 } }),
                            React.createElement(antd_1.Typography.Text, null, "\u7070\u8272\uFF1A\u672A\u751F\u7522/\u672A\u77E5")))))),
        React.createElement(antd_1.Typography.Paragraph, { className: "text-gray-400 text-xs mt-4" })));
}
