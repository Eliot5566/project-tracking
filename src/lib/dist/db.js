...
var hasInstance = !!process.env.DB_INSTANCE;
var config = __assign(__assign({ user: process.env.DB_USER || 'sa', password: process.env.DB_PASSWORD || 'YourStrong@Passw0rd', server: process.env.DB_SERVER || 'localhost', database: process.env.DB_NAME || 'ProjectTracking' }, (hasInstance
    ? {}
    : { port: parseInt(process.env.DB_PORT || '1433') })), { options: __assign({ encrypt: true, trustServerCertificate: true }, (hasInstance && process.env.DB_INSTANCE
